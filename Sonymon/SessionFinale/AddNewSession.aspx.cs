...
public partial class AddNewSession : System.Web.UI.Page
{
    ...
    {
        db.Connect();
        //db.Fetch("Select * from presenter where pr_ss_id=" + Convert.ToInt16(Session["sessionId"]));
        db.Read("PR_GetRecordById", "'" + Convert.ToInt16(Session["sessionId"]) + "','" + orgId + "','" + eventId + "'");
    ...
    {
        db.Connect();
        //db.Fetch("Select * from additionalreq where ar_ss_id = " + Convert.ToInt16(Session["sessionId"]));
        db.Read("AR_GetRecordById", "'" + Convert.ToInt16(Session["sessionId"]) + "','" + orgId + "','" + eventId + "'");
    ...
    protected void gvPresenter_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("AddNew"))
        {
            ...
            db.Connect();
            db.Fetch("select pr_name from presenter where pr_name = '" + txtName.Text + "' and pr_ss_id = " + Convert.ToInt16(Session["sessionId"]) + " and pr_org_id =" + orgId + " and pr_ev_id =" + eventId);
            ...
            if (db.ds.Tables[0].Rows.Count == 0)
            {
                if (txtName.Text.ToString().Length != 0 && txtTopic.Text.ToString().Length != 0)
                {
                    ...
                    db.Connect();
                    //db.Fetch("insert into presenter(pr_ss_id,pr_name,pr_topic) values(" + Convert.ToInt16(Session["sessionId"]) + ",'" +
                    //    txtName.Text + "','" + txtTopic.Text + "')");
                    db.Read("PR_InsertRecord", "'" + Convert.ToInt16(Session["sessionId"]) + "','" + txtName.Text + "','" + txtTopic.Text + "','" + orgId + "','" + eventId + "'");
    ...
    protected void gvPresenter_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        db.Connect();
        //db.Fetch("delete from presenter where pr_id=" + id);
        db.Read("PR_DeleteRecordById", "'" + id + "','" + orgId + "','" + eventId + "'");
    ...
    protected void gvPresenter_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        db.Connect();
        //db.Fetch("update presenter set pr_name='" + txtName.Text + "',pr_topic='" + txtTopic.Text + "' where pr_id=" + id);
        db.Read("PR_UpdateRecordById", "'" + id + "','" + txtName.Text + "','" + txtTopic.Text + "','" + orgId + "','" + eventId + "'");
    ...
    protected void gvAdditionalReq_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("AddNew"))
        {
            ...
            {
                db.Connect();
                //db.Fetch("insert into additionalreq(ar_ss_id,ar_equipment,ar_specification) values(" + Convert.ToInt16(Session["sessionId"]) + ",'" +
                //    txtEquipment.Text + "','" + txtSpecification.Text + "')");
                db.Read("AR_InsertRecord", "'" + Convert.ToInt16(Session["sessionId"]) + "','" + txtEquipment.Text + "','" + txtSpecification.Text + "','" + orgId + "','" + eventId + "'");
    ...
    protected void gvAdditionalReq_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        db.Connect();
        //db.Fetch("delete from additionalreq where ar_id=" + id);
        db.Read("AR_DeleteRecordById", "'" + id + "','" + orgId + "','" + eventId + "'");
    ...
    protected void gvAdditionalReq_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        db.Connect();
       // db.Fetch("update additionalreq set ar_equipment='" + txtEquipment.Text + "',ar_specification='" + txtSpecification.Text + "' where ar_id=" + id);
        db.Read("AR_UpdateRecordById", "'" + id + "','" + txtEquipment.Text + "','" + txtSpecification.Text + "','" + orgId + "','" + eventId + "'");
        gvAdditionalReq.EditIndex = -1;
        BindAdditionalReq(); BindPresenter();
    }
    ...
    protected void SetFields()
    {
        ...
        db.Connect();
        //db.Fetch("select * from session where ss_id=" + Session["id"]);
        db.Read("SS_GetRecordById", "'" + Session["id"] + "','" + orgId + "','" + eventId + "'");   
        ...
        //txtMdtrMName.Text = db.ds.Tables[0].Rows[0]["ss_mdtr_mname"].ToString();
        //txtMdtrLName.Text = db.ds.Tables[0].Rows[0]["ss_mdtr_lname"].ToString();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (IsValidControls())
        {
            ...
            if (Session["command"] != null && Session["command"].Equals("EditSession"))
            {
                ...
                db.Connect();
                db.Read("SS_UpdateRecordById", "'" + Convert.ToInt16(Session["sessionId"]) + "','" + title + "','" + description + "','" + mdtrName + "','" + maxNoAtnd + "','" + priorPaperSubm + "','" + sharingOption + "','" + addReq + "','" + priceAttend + "','" + modifiedTime + "','" + orgId + "','" + eventId + "','" + userId + "'");
            }
            else
            {
                var createdTime = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                ...
                db.Connect();
                db.Read("SS_InsertRecord", "'" + Convert.ToInt16(Session["sessionId"]) + "','" + title + "','" + description + "','" + mdtrName + "','" + maxNoAtnd + "','" + priorPaperSubm + "','" + sharingOption + "','" + addReq + "','" + priceAttend + "','" + createdTime + "','" + orgId + "','" + eventId + "','" + userId + "'");
            }
            ...
            if (cbAdditionalRequirement.Checked == false)
            {
                ...
                db.Read("AR_DeleteRecordBySSId", "'" + Convert.ToInt16(Session["sessionId"]) + "','" + orgId + "','" + eventId + "'");
            }
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            db.Read("PR_DeleteRecordBySSId", "'" + Convert.ToInt16(Session["sessionId"]) + "','" + orgId + "','" + eventId + "'");
    ...
    protected void txtTitle_TextChanged(object sender, EventArgs e)
    {
        ...
        BindAdditionalReq();
        db.Connect();
        db.Fetch("select ss_title from session where ss_title = '" + txtTitle.Text.ToString() + "' and ss_org_id=" +orgId+ " and ss_ev_id="+eventId);
        if (db.ds.Tables[0].Rows.Count == 0)
