...
public class Class1
{
    ...
    public void conn()
    {
        cn = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=D:\event_service\App_Data\event_webservice.mdf;Integrated Security=True;User Instance=True");
        cn.Open();
    }
    public int rvalue;
