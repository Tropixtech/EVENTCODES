...
{
    var option_str = document.getElementById('ctl00_ContentPlaceHolder1_ddCountry');
	option_str.length=0;
	option_str.options[0] = new Option('Select Country','');
	option_str.selectedIndex = 0;
	//var country1 = document.getElementById('ctl00_ContentPlaceHolder1_ddCountry');
...
function print_state(state_index){
    var option_str = document.getElementById('ctl00_ContentPlaceHolder1_ddState');
	option_str.length=0;	
